...
describe('Exchange Manager', () => {
  ...
  describe('Exchange Creation', () => {
    ...
    test('should fail to create unsupported exchange', async () => {
      await expect(exchangeManager.createExchange('unsupported', testCredentials))
        .rejects
  ...
  describe('Exchange Management', () => {
    test('should add exchange for user', async () => {
      const exchangeId = await exchangeManager.addExchange(testUserId, 'binance', testCredentials, true);
    ...
    test('should get user exchanges', async () => {
      ...
      await exchangeManager.addExchange(testUserId, 'coinbase', { ...testCredentials, passphrase: 'test' }, true);
  ...
  describe('Statistics', () => {
    test('should get manager statistics', async () => {
      await exchangeManager.addExchange(testUserId, 'binance', testCredentials, true);
      await exchangeManager.addExchange('another-user', 'coinbase', { ...testCredentials, passphrase: 'test' }, true);
