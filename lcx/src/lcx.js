...
import { ExchangeError, ExchangeNotAvailable, BadResponse, BadRequest, InvalidOrder, InsufficientFunds, AuthenticationError, RateLimitExceeded, InvalidAddress, DDoSProtection, BadSymbol } from './base/errors.js';
...
export default class lcx extends Exchange {
    ...
    sign (path, api = 'public', method = 'GET', params = {}, headers = undefined, body = undefined) {
        ...
        if (api === 'private') {
            ...
            const signature1 = this.hmac(this.encode(payload), this.encode(this.secret), sha256);

            const signatureBuffer = Buffer.from(signature1, 'hex');
